...
export function Footer() {
  return (
    <footer className="hidden w-full border-t border-transparent bg-sidebar text-sidebar-foreground md:block flex items-center justify-between gap-4 px-2" >
      <div className="container mx-auto grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 py-12">
        <div className="text-center col-span-2 lg:col-span-1 items-center justify-center">
